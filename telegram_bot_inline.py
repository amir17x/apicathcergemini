...
class InlineTelegramBot:
    ...
    def prompt_for_proxy(self, chat_id, user_id):
        ...
        proxy_text = (
            "🌐 <b>تنظیم پروکسی</b>\n\n"
            "لطفاً پروکسی خود را با یکی از فرمت‌های زیر وارد کنید:\n\n"
            "<code>protocol://username:password@host:port</code>\n"
            "یا به سادگی:\n"
            "<code>host:port</code>\n\n"
            "مثال‌ها:\n"
            "<code>socks5://user:pass@1.2.3.4:1080</code>\n"
            "<code>http://5.6.7.8:8080</code>\n"
            "<code>198.8.94.170:4145</code>\n\n"
            "<b>لیست پروکسی‌ها:</b> شما می‌توانید لیستی از پروکسی‌ها را وارد کنید (هر پروکسی در یک خط) و ربات آنها را یکی یکی بررسی خواهد کرد تا اولین پروکسی کارآمد را پیدا کند.\n\n"
