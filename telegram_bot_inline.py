...
class InlineTelegramBot:
    ...
    def show_main_menu(self, chat_id, user_id):
        ...
        welcome_text = (
            "🌟🤖 <b>به ربات حرفه‌ای و هوشمند ساخت حساب Gmail و کلید API جمینای خوش آمدید</b> 🤖🌟\n\n"
            "📱 <b>نسخه 2.0.0</b> | 🔄 <b>آخرین بروزرسانی:</b> فروردین ۱۴۰۴\n\n"
            
            "🚀 <b>این ربات چه کاری انجام می‌دهد؟</b>\n"
            "🔸 ساخت خودکار حساب Gmail بدون نیاز به شماره تلفن\n"
            "🔸 دریافت آنی کلید API مدل‌های هوش مصنوعی Google Gemini\n"
            "🔸 مدیریت هوشمند پروکسی برای عبور از محدودیت‌های گوگل\n"
            "🔸 ذخیره‌سازی امن حساب‌ها و کلیدهای API\n\n"
            
            "✨ <b>ویژگی‌های منحصر به فرد:</b>\n"
            "• 🌐 پشتیبانی از انواع پروکسی (HTTP، HTTPS، SOCKS4، SOCKS5)\n"
            "• 📁 قابلیت آپلود فایل لیست پروکسی (تا 100 پروکسی)\n"
            "• 💼 مدیریت حرفه‌ای حساب‌ها با تاریخچه کامل\n"
            "• 🔄 امکان ساخت چندین حساب (تا 5 حساب) به صورت همزمان\n"
            "• 📊 نمایش آمار و وضعیت حساب‌های ساخته شده\n"
            "• 🛡️ محافظت از داده‌ها با ذخیره‌سازی امن اطلاعات\n\n"
            ...
            "👇 <b>از دکمه‌های شیشه‌ای زیر برای شروع کار استفاده کنید</b> 👇"
        )
